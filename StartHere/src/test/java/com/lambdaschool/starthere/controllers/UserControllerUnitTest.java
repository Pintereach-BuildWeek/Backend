...
public class UserControllerUnitTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        u1.getUserarticles()
                .add(new UserArticles("title","summary","http://link-1", "Java/Spring", u1));
        u1.getUserarticles()
                .add(new UserArticles("title","summary","http://link-2", "Node/Express", u1));
        ...
        u2.getUserarticles()
                .add(new UserArticles("title","summary","http://link-2-1", "Java/Spring", u2));
        u2.getUserarticles()
                .add(new UserArticles("title","summary","http://link-2-1", "Java/Spring", u2));
//        u2.getUseremails()
//          .add(new Useremail(u2, "bunny@email.local"));
        ...
        u3.getUserarticles()
                .add(new UserArticles("title","summary","http://link-3-1", "REACT", u3));
        userService.save(u3);
